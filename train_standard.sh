...
python -u train.py --name raft-kitti  --stage kitti --validation kitti --restore_ckpt checkpoints/16001_raft-kitti.pth --gpus 0  --num_steps 100000 --batch_size 1 --lr 0.0001 --image_size 288 960 --wdecay 0.00001 --gamma=0.85
